...
// Query TypeMap
// Note: Module augmentation for @sanity/client removed as it's not installed.
// This project uses next-sanity with defineQuery, which doesn't require this augmentation.
